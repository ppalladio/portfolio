    ...
    return (
        ...
        >
            ...
            <div className="z-30 basis-2/5 mt-12 md:mt-32">
                ...
                >
                    <p className="text-6xl font-merriweather  text-center md:text-start xs:tracking-md">
                        Yuxuan <br />
                        <span
                            className="xs:relative xs:text-deep-blue xs:font-semibold xs:tracking-md
						"
                        >
                            Peng
                        </span>
